    ...
    <footer className="bg-[#050509] border-t border-purple-500/10 mt-auto">
      ...
      <div className="max-w-7xl mx-auto px-5 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          {/* Plataforma column */}
          <div>
            <h4 className="text-white/60 text-xs font-bold uppercase tracking-widest mb-4">Plataforma</h4>
          ...
          {/* Agencia column */}
          <div>
            <h4 className="text-white/60 text-xs font-bold uppercase tracking-widest mb-4">Agencia</h4>
            <ul className="space-y-2.5">
              {agenciaLinks.map((l) => (
                <li key={l.href + l.label}>
                  <Link href={l.href} className="text-white/40 hover:text-purple-400 text-sm transition-colors">{l.label}</Link>
