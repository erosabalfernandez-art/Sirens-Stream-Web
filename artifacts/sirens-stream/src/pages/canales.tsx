        ...
        <div className="max-w-3xl mx-auto px-4">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/25 rounded-full px-3 py-1 mb-3">
              ...
              <span className="text-blue-300 text-xs font-semibold uppercase tracking-wider">Canal de la Agencia</span>
            </div>
            <h1 className="text-2xl font-extrabold">Comunicados</h1>
            <p className="text-white/40 text-sm mt-1">Mensajes oficiales de Eclipse Angels Agency</p>
          </div>
          ...
          {fetching ? (
            ...
            <div className="bg-[#0d0d1e] border border-purple-500/10 rounded-2xl p-16 text-center">
              ...
              <p className="text-white/40 text-sm">No tienes acceso a ningún canal todavía.</p>
              <p className="text-white/25 text-xs mt-1">Agrega una app en tu perfil para solicitar acceso automáticamente.</p>
            </div>
          ) : (
            <>
              {pendingApps.length > 0 && (
                <div className="bg-amber-500/10 border border-amber-500/20 rounded-2xl p-4 mb-6">
                  <p className="text-amber-300 text-sm font-semibold mb-1">⏳ Solicitudes pendientes de aprobación</p>
                  <p className="text-amber-200/60 text-xs">
                    {pendingApps.join(', ')} — Tu agencia revisará tu solicitud pronto.
                  </p>
                </div>
              )}
              ...
              {approvedApps.length === 0 ? (
                <div className="bg-[#0d0d1e] border border-purple-500/10 rounded-2xl p-16 text-center">
                  ...
                  <p className="text-white/40 text-sm">Tu solicitud está siendo revisada.</p>
                  <p className="text-white/25 text-xs mt-1">Te notificaremos cuando seas aprobada.</p>
                </div>
